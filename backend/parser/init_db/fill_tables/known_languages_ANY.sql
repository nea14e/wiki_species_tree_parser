WITH cte(lang_key, comment, translations) AS (
  VALUES ('ru', 'Русский',
    '{
        ...
        "read_on_wiki": "Читать на РуВики",
        "search_in_yandex": "Искать в Yandex",
        ...
        "favorites": "Избранное",
        "favorites_is_empty": "В избранном ничего нет",
        ...
        "detach_from_tree": "Отвязать от дерева",
    ...
    ('en', 'English',
      '{
        ...
        "rank_word": "Rank",
        "parent_word": "Parent",
        "read_on_wiki": "Read on RuWiki",
        "search_in_yandex": "Search with Yandex",
        ...
        "detach_from_tree": "Detach from tree",
